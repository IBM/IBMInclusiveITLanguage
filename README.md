...
Communicating effectively and cohesively is the work of all developers and content creators. The words we use must reflect our values and create an environment where everyone can feel included and psychologically safe. Arvind Krishna asked IBMers to take the Emb(race) pledge. One of the statements in this pledge is "I pledge to demonstrate equality through action." Reinforcing that we use words in IT that are free from racial and cultural bias, demonstrates our commitment to equality.
