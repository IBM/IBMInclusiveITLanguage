...
Communicating effectively and cohesively is the work of all developers and content creators. The words we use must reflect our values and create an environment where everyone can feel included and psychologically safe. Arvind Krishna asked IBMers to take the Emb(race) pledge. One of the statements in this pledge is "I pledge to demonstrate equality through action." By reinforcing that we use words that are free of racial and cultural bias, we take that action to demonstrate equality.
